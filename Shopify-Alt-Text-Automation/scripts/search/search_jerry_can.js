...
// Search for Jerry Can products
const jerryCanProducts = productsData.products.filter(product => {
    return product.title.toLowerCase().includes('jerry can');
});

console.log('Found Jerry Can products:');
jerryCanProducts.forEach((product, index) => {
